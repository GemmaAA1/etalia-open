...
class ConsumerPubmedTest(TestCase):
    ...
    def setUp(self):
        ...
        with open('etalia/consumers/tests/pubmed_sample.json') as file:
    ...
    @patch('etalia.consumers.models.ConsumerPubmed.consume_journal')
...
class ConsumerElsevierTest(TestCase):
    ...
    def setUp(self):
        ...
        with open('etalia/consumers/tests/elsevier_sample.json') as file:
            self.entries = json.load(file)
    ...
    @patch('etalia.consumers.models.ConsumerElsevier.consume_journal')
    def test_consume_update_journal(self, mock_consume_journal):
        # setup mock object
        mock_consume_journal.return_value = self.entries, True
