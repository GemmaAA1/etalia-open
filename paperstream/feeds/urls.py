...
urlpatterns = [
    ...
    url(r'stream2/$', views.stream_view2, name='stream2'),
    url(r'stream2/filter$', views.stream_view2_filter, name='stream2_filter'),
    ...
    url(r'trend2/$', views.trend_view2, name='trend2'),
    url(r'trend2/filter$', views.trend_view2_filter, name='trend2_filter'),
