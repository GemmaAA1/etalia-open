    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('id_issn', etalia.core.models.NullableCharField(default='', blank=True, null=True, validators=[etalia.library.validators.validate_issn], db_index=True, verbose_name='ISSN', max_length=9, unique=True)),
                ('id_eissn', etalia.core.models.NullableCharField(default='', blank=True, null=True, validators=[etalia.library.validators.validate_issn], db_index=True, verbose_name='e-ISSN', max_length=9, unique=True)),
                ('id_arx', etalia.core.models.NullableCharField(default='', blank=True, null=True, db_index=True, verbose_name='Arxiv ID', max_length=32, unique=True)),
                ('id_oth', etalia.core.models.NullableCharField(default='', blank=True, null=True, db_index=True, verbose_name='Other ID', max_length=32, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_doi', etalia.core.models.NullableCharField(default='', blank=True, null=True, db_index=True, verbose_name='DOI', max_length=64, unique=True)),
                ('id_arx', etalia.core.models.NullableCharField(default='', blank=True, null=True, db_index=True, verbose_name='Arxiv', max_length=64, unique=True)),
                ('id_pmi', etalia.core.models.NullableCharField(default='', blank=True, null=True, db_index=True, verbose_name='PMID', max_length=64, unique=True)),
                ('id_pii', etalia.core.models.NullableCharField(default='', blank=True, null=True, db_index=True, verbose_name='PII', max_length=64)),
                ('id_isbn', etalia.core.models.NullableCharField(default='', blank=True, null=True, db_index=True, verbose_name='ISBN', max_length=64, unique=True)),
                ('id_oth', etalia.core.models.NullableCharField(default='', blank=True, null=True, db_index=True, verbose_name='Other ID', max_length=64, unique=True)),
