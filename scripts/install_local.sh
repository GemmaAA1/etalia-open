...
: "${DJANGO_AWS_REGION?Error: Need to set env var DJANGO_AWS_REGION}"
: "${DJANGO_AWS_ACCESS_KEY_ID?Error: Need to set env var DJANGO_AWS_ACCESS_KEY_ID}"
: "${DJANGO_AWS_SECRET_ACCESS_KEY?Error: Need to set env var DJANGO_AWS_SECRET_ACCESS_KEY}"
: "${DJANGO_AWS_STORAGE_BUCKET_NAME?Error: Need to set env var DJANGO_AWS_STORAGE_BUCKET_NAME}"
: "${DJANGO_SETTINGS_MODULE?Error: Need to set env var DJANGO_SETTINGS_MODULE}"
