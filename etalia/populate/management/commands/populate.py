...
from etalia.populate.utils import populate_publisher, populate_journal, \
    populate_consumer
...
class Command(BaseCommand):
    """
    Pre-Populate etalia models: Three models <what> can be populated:
    ...
    help = 'Pre-Populate etalia models'
