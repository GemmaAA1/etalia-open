...
urlpatterns = [
    ...
    url(r'^paper/(?P<pk>[0-9]+)/$', views.paper_redirect, name='paper-redirect'),
    url(r'^paper/(?P<slug>[a-zA-Z0-9-]+)_(?P<pk>[0-9]+)/$', views.paper_redirect_slug, name='paper-redirect-slug'),
]
